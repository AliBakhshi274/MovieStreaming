...
public class AdapterSeriesComplete extends RecyclerView.Adapter<AdapterSeriesComplete.MyViewholder> {

    Context context;
    List<Series> data;


    public AdapterSeriesComplete(Context context, List<Series> data) {
    ...
    public MyViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_series_complete, parent, false);
